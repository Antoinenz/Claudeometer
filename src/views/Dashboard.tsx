  ...
  if (kind === "offline") {
    return (
      <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <circle cx="12" cy="18.25" r="1" fill="currentColor" stroke="none" />
      ...
      >
        ...
        <div className="flex items-center gap-0.5">
          <button
            ...
            className={`relative p-1.5 rounded-md transition-colors duration-200 disabled:opacity-40 ${
              inCooldown
                ? "cursor-default text-zinc-500"
                : `${isFocused ? "text-zinc-500" : "text-zinc-700"} hover:text-zinc-200 hover:bg-zinc-800/80`
            }`}
          >
            <div
            ...
            {inCooldown && !hideCooldownBadge && (
              <span className="absolute bottom-0 -right-0.5 text-[9px] font-mono leading-none text-zinc-500 bg-[#101010] px-[1px] tabular-nums">
                {secsLeft}
              </span>
            )}
          </button>
          <button
            onClick={onSettings}
            title="Settings"
            className={`p-1.5 rounded-md transition-colors duration-200 hover:text-zinc-200 hover:bg-zinc-800/80 ${isFocused ? "text-zinc-500" : "text-zinc-700"}`}
          >
